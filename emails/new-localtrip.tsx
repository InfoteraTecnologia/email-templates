            ...
            <Container
              ...
              <Section className='mt-8'>
                ...
                <Text className='text-primary m-0 mt-6'>
                  ...
                  <Link
                    href='mailto:info@noronhatour.com.br'
                    className='m-0 uppercase underline'
                    style={fontBold}>
              ...
              <Section>
                <ul className='m-0 mt-4 pl-5'>
                  <li>
                    <Text
                      className='text-primary m-0 uppercase'
                      style={fontBold}>
              ...
              <Section className='mt-12'>
                <Row>
                  <Column>
                    {' '}
                    <Text className='text-primary m-0 w-32'>
                      Atenciosamente, Equipe Infotravel
                    </Text>
                  </Column>
                  <Column align='right'>
                    <Img
